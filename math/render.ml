...
let cmd_dvipng tmpprefix finalpath = "dvipng -bg Transparent -fg rgb 1.0 1.0 1.0 -gamma 1.5 -D 120 -T tight --strict " ^ tmpprefix ^ ".dvi -o " ^ finalpath ^ " >/dev/null 2>/dev/null"
