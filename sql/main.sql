...
(1,	1,	'group',	'banned',	'',	0,	0),
(2,	1,	'group',	'create-public-post',	'',	0,	1),
(3,	1,	'group',	'create-public-thread',	'',	0,	1),
(4,	1,	'group',	'edit-own-title',	'',	0,	1),
(5,	1,	'group',	'rename-own-thread',	'',	0,	1),
(6,	1,	'group',	'update-own-post',	'',	0,	1),
(7,	1,	'group',	'update-own-profile',	'',	0,	1),
(8,	2,	'group',	'create-private-forum-post',	'forums',	1,	1),
(9,	2,	'group',	'create-private-forum-post',	'forums',	2,	1),
(10,	2,	'group',	'create-private-forum-thread',	'forums',	1,	1),
(11,	2,	'group',	'create-private-forum-thread',	'forums',	2,	1),
(12,	2,	'group',	'create-public-thread',	'',	0,	0),
(13,	2,	'group',	'delete-forum-post',	'forums',	1,	1),
(14,	2,	'group',	'delete-forum-post',	'forums',	2,	1),
(15,	2,	'group',	'delete-forum-thread',	'forums',	1,	1),
(16,	2,	'group',	'delete-forum-thread',	'forums',	2,	1),
(17,	2,	'group',	'edit-forum-post',	'forums',	1,	1),
(18,	2,	'group',	'edit-forum-post',	'forums',	2,	1),
(19,	2,	'group',	'edit-forum-thread',	'forums',	1,	1),
(20,	2,	'group',	'edit-forum-thread',	'forums',	2,	1),
(21,	2,	'group',	'view-private-category',	'categories',	1,	1),
(22,	2,	'group',	'view-private-forum',	'forums',	1,	1),
(23,	2,	'group',	'view-private-forum',	'forums',	2,	1),
(24,	2,	'group',	'view-public-categories',	'',	0,	0),
(25,	2,	'group',	'view-public-forums',	'',	0,	0),
(26,	3,	'group',	'create-pms',	'',	0,	0),
(27,	3,	'group',	'create-public-post',	'',	0,	0),
(28,	3,	'group',	'create-public-thread',	'',	0,	0),
(29,	3,	'group',	'delete-own-pms',	'',	0,	0),
(30,	3,	'group',	'rename-own-thread',	'',	0,	0),
(31,	3,	'group',	'update-own-post',	'',	0,	0),
(32,	3,	'group',	'update-own-profile',	'',	0,	0),
(33,	3,	'group',	'use-post-layout',	'',	0,	0),
(34,	3,	'group',	'view-own-pms',	'',	0,	0),
(35,	4,	'group',	'create-private-forum-post',	'forums',	2,	0),
(36,	4,	'group',	'create-private-forum-thread',	'forums',	2,	0),
(37,	4,	'group',	'delete-forum-post',	'forums',	2,	0),
(38,	4,	'group',	'delete-forum-thread',	'forums',	2,	0),
(39,	4,	'group',	'edit-forum-post',	'forums',	2,	0),
(40,	4,	'group',	'edit-forum-thread',	'forums',	2,	0),
(41,	4,	'group',	'has-displayname',	'',	0,	0),
(42,	4,	'group',	'view-private-category',	'categories',	2,	0),
(43,	4,	'group',	'view-private-forum',	'forums',	2,	0),
(44,	5,	'group',	'ban-users',	'',	0,	0),
(45,	5,	'group',	'create-forum-announcements',	'',	0,	0),
(46,	5,	'group',	'delete-post',	'',	0,	0),
(47,	5,	'group',	'delete-thread',	'',	0,	0),
(48,	5,	'group',	'override-closed',	'',	0,	0),
(49,	5,	'group',	'show-as-staff',	'',	0,	0),
(50,	5,	'group',	'update-post',	'',	0,	0),
(51,	5,	'group',	'update-thread',	'',	0,	0),
(52,	5,	'group',	'view-post-history',	'',	0,	0),
(53,	6,	'group',	'create-all-private-forum-posts',	'',	0,	0),
(54,	6,	'group',	'create-all-private-forum-threads',	'',	0,	0),
(55,	6,	'group',	'edit-all-group',	'',	0,	0),
(56,	6,	'group',	'edit-attentions-box',	'',	0,	0),
(57,	6,	'group',	'edit-categories',	'',	0,	0),
(58,	6,	'group',	'edit-forums',	'',	0,	0),
(59,	6,	'group',	'edit-ip-bans',	'',	0,	0),
(60,	6,	'group',	'edit-permissions',	'',	0,	0),
(61,	6,	'group',	'edit-titles',	'',	0,	0),
(62,	6,	'group',	'edit-users',	'',	0,	0),
(63,	6,	'group',	'has-customusercolor',	'',	0,	0),
(64,	6,	'group',	'manage-board',	'',	0,	0),
(65,	6,	'group',	'override-readonly-forums',	'',	0,	0),
(66,	6,	'group',	'show-as-staff',	'',	0,	0),
(67,	6,	'group',	'update-profiles',	'',	0,	0),
(68,	6,	'group',	'view-all-private-categories',	'',	0,	0),
(69,	6,	'group',	'view-all-private-forums',	'',	0,	0),
(70,	6,	'group',	'view-all-private-posts',	'',	0,	0),
(71,	6,	'group',	'view-all-private-threads',	'',	0,	0),
(72,	6,	'group',	'view-post-ips',	'',	0,	0),
(73,	7,	'group',	'no-restrictions',	'',	0,	0),
(74,	7,	'group',	'show-as-staff',	'',	0,	0);
