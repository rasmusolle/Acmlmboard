...
INSERT INTO `group` (`id`, `title`, `nc`, `inherit_group_id`, `default`, `banned`, `sortorder`, `visible`, `primary`) VALUES
(1,	'Base User',	'',	0,	0,	0,	100,	0,	0),
(2,	'Normal User',	'4f77ff',	1,	1,	0,	200,	1,	1),
...
(2,	1,	'group',	'view-public-categories',	'',	0,	0),
(3,	1,	'group',	'view-public-forums',	'',	0,	0),
(4,	2,	'group',	'create-public-post',	'',	0,	0),
(5,	2,	'group',	'create-public-thread',	'',	0,	0),
(6,	2,	'group',	'update-own-post',	'',	0,	0),
(7,	2,	'group',	'use-post-layout',	'',	0,	0),
(8,	3,	'group',	'delete-post',	'',	0,	0),
(9,	3,	'group',	'delete-thread',	'',	0,	0),
(10,	3,	'group',	'update-post',	'',	0,	0),
(11,	3,	'group',	'update-thread',	'',	0,	0),
(12,	3,	'group',	'view-post-history',	'',	0,	0),
(13,	4,	'group',	'edit-attentions-box',	'',	0,	0),
(14,	4,	'group',	'edit-categories',	'',	0,	0),
(15,	4,	'group',	'edit-forums',	'',	0,	0),
(16,	4,	'group',	'edit-permissions',	'',	0,	0),
(17,	4,	'group',	'view-all-private-categories',	'',	0,	0),
(18,	4,	'group',	'view-all-private-forums',	'',	0,	0),
(19,	4,	'group',	'view-all-private-posts',	'',	0,	0),
(20,	4,	'group',	'view-all-private-threads',	'',	0,	0),
(21,	6,	'group',	'no-restrictions',	'',	0,	0),
(22,	4,	'group',	'create-all-private-forum-threads',	'',	0,	0),
(23,	4,	'group',	'create-all-private-forum-posts',	'',	0,	0),
(24,	10,	'group',	'view-private-category',	'categories',	2,	0),
(25,	9,	'group',	'create-public-thread',	'',	0,	1),
(26,	9,	'group',	'create-public-post',	'',	0,	1),
(27,	9,	'group',	'update-own-post',	'',	0,	1),
(28,	9,	'group',	'update-own-profile',	'',	0,	1),
(29,	4,	'group',	'update-profiles',	'',	0,	0),
(30,	9,	'group',	'banned',	'',	0,	0),
(31,	2,	'group',	'rename-own-thread',	'',	0,	0),
(32,	4,	'group',	'view-post-ips',	'',	0,	0),
(33,	4,	'group',	'edit-users',	'',	0,	0),
(34,	2,	'group',	'create-pms',	'',	0,	0),
(35,	2,	'group',	'delete-own-pms',	'',	0,	0),
(36,	2,	'group',	'view-own-pms',	'',	0,	0),
(37,	4,	'group',	'override-readonly-forums',	'',	0,	0),
(38,	9,	'group',	'rename-own-thread',	'',	0,	1),
(39,	4,	'group',	'edit-ip-bans',	'',	0,	0),
(40,	3,	'group',	'create-forum-announcements',	'',	0,	0),
(41,	5,	'group',	'view-private-forum',	'',	21,	0),
(42,	5,	'group',	'create-private-forum-post',	'',	21,	0),
(43,	5,	'group',	'create-private-forum-thread',	'',	21,	0),
(44,	10,	'group',	'has-displayname',	'',	0,	0),
(45,	3,	'group',	'show-as-staff',	'',	0,	0),
(46,	4,	'group',	'show-as-staff',	'',	0,	0),
(47,	9,	'group',	'edit-own-title',	'',	0,	1),
(48,	3,	'group',	'override-closed',	'',	0,	0),
(49,	4,	'group',	'manage-board',	'',	0,	0),
(50,	4,	'group',	'edit-all-group',	'',	0,	0),
(51,	1,	'group',	'create-public-thread',	'',	0,	0),
(52,	3,	'group',	'ban-users',	'',	0,	0),
(53,	4,	'group',	'has-customusercolor',	'',	0,	0),
(54,	1,	'group',	'create-private-forum-post',	'forums',	2,	1),
(55,	1,	'group',	'create-private-forum-thread',	'forums',	2,	1),
(56,	1,	'group',	'delete-forum-post',	'forums',	2,	1),
(57,	1,	'group',	'delete-forum-thread',	'forums',	2,	1),
(58,	1,	'group',	'edit-forum-post',	'forums',	2,	1),
(59,	1,	'group',	'edit-forum-thread',	'forums',	2,	1),
(60,	1,	'group',	'view-private-forum',	'forums',	2,	1),
(61,	10,	'group',	'create-private-forum-post',	'forums',	2,	0),
(62,	10,	'group',	'create-private-forum-thread',	'forums',	2,	0),
(63,	10,	'group',	'delete-forum-post',	'forums',	2,	0),
(64,	10,	'group',	'delete-forum-thread',	'forums',	2,	0),
(65,	10,	'group',	'edit-forum-post',	'forums',	2,	0),
(66,	10,	'group',	'edit-forum-thread',	'forums',	2,	0),
(67,	10,	'group',	'view-private-forum',	'forums',	2,	0),
(68,	1,	'group',	'create-private-forum-post',	'forums',	1,	1),
(69,	1,	'group',	'create-private-forum-thread',	'forums',	1,	1),
(70,	1,	'group',	'delete-forum-post',	'forums',	1,	1),
(71,	1,	'group',	'delete-forum-thread',	'forums',	1,	1),
(72,	1,	'group',	'edit-forum-post',	'forums',	1,	1),
(73,	1,	'group',	'edit-forum-thread',	'forums',	1,	1),
(74,	1,	'group',	'view-private-forum',	'forums',	1,	1),
(75,	1,	'group',	'view-private-category',	'categories',	1,	1),
