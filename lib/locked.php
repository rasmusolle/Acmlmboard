...
<head><title><?php echo "$boardtitle"; ?></title></head>
<body bgcolor="#101020">
...
<tr><td><?php if($a['txtval'] != '') echo $a['txtval']; else echo "Access to the board has been restricted by the administration.<br />Please forgive any inconvenience caused and stand by until the underlying issues have been resolved.";?></td></tr>
</table>
</td>
</tr>
